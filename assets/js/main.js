        ...
        if (pais === "cl") {
            ...
            btnCanal.addEventListener('click', () => {
                ...
                if (typeof iframe_url !== 'undefined'){     
                    ...
                    barraNombre.append(crearBarraNombre(`https://www.youtube.com/channel/${yt_id}`));
                } 
                // si posee enlace 'fuente' utlizalo en 'barraNombre'
                if (typeof fuente !== 'undefined') {barraNombre.append(crearBarraNombre(fuente));}
...
btnQuitarSeñal.addEventListener('click', () => {
    limpiarTransmisionActiva()
    recordatorio.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="calc(1.6rem + 1.7vw)" height="calc(1.6rem + 1.7vw)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width=".7" stroke-linecap="round" stroke-linejoin="round" class="ai ai-FaceSad"><circle cx="12" cy="12" r="10"/><path d="M8 9.05v-.1"/><path d="M16 9.05v-.1"/><path d="M16 16c-.5-1.5-1.79-3-4-3s-3.5 1.5-4 3"/></svg>FF';
